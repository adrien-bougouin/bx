...
def assert_equal(expected, actual, data_type: 'value')
  ...
  raise(
    AssertionError,
    "Expected #{data_type} #{expected.inspect} but got #{actual.inspect}"
  )
end
...
def assert_not_equal(expected, actual, data_type: 'value')
  ...
  raise(
    AssertionError,
    "Expected #{data_type} #{expected.inspect} to not be #{actual.inspect}"
  )
end
...
def assert_include(expected, actual, data_type: 'value')
  ...
  raise(
    AssertionError,
    "Expected #{data_type} #{expected} to be included in #{actual}"
  )
end
